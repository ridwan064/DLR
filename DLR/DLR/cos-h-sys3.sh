...
pdsh -w cosbench 'cd /home/ceph-user/cos; sh cli.sh submit conf/workload3.xml' &
...
#2G,180
#(pdsh -w node1,node2,node4,node5 'cd /home/ceph-user/fio-data;fio --name=randread --ioengine=libaio --iodepth=16 --rw=randread --bs=4k --direct=0 --size=2G --numjobs=4 --runtime=400 --group_reporting --output rados_seq_fio'; pdsh -w node1,node2,node4,node5 'cd /home/ceph-user/fio-data;fio --name=randread --ioengine=libaio --iodepth=16 --rw=randread --bs=4k --direct=0 --size=2G --numjobs=4 --runtime=400 --group_reporting --output rados_seq_fio') &
#(pdsh -w node1,node2,node4,node5 'sysbench --num-threads=256 --test=cpu --cpu-max-prime=500000 run --max-time=400s'; pdsh -w node1,node2,node4,node5 'sysbench --num-threads=256 --test=cpu --cpu-max-prime=500000 run --max-time=400s') &
#(pdsh -w node1,node2,node4,node5 'sysbench --num-threads=256 --test=cpu --cpu-max-prime=500000 run --max-time=400s'; pdsh -w node1,node2,node4,node5 'sysbench --num-threads=256 --test=cpu --cpu-max-prime=500000 run --max-time=400s') &
#pdsh -w node1,node2,node4,node5 'sysbench --num-threads=128 --test=cpu --cpu-max-prime=500000 run --max-time=400s' &
(pdsh -w node1,node2,node4,node5 'sysbench --test=memory --memory-block-size=100M --memory-total-size=7000G --num-threads=256 --memory-oper=write run'; pdsh -w node1,node2,node4,node5 'sysbench --test=memory --memory-block-size=100M --memory-total-size=7000G --num-threads=256 --memory-oper=write run') &

#pdsh -w node1,node2 'iperf -s -w 4M' &
#sleep 200
#pdsh -w node4 'iperf -c node1 -w 8M -t 400 -P 50' &
#pdsh -w node5 'iperf -c node2 -w 8M -t 400 -P 50' &
