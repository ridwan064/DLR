...
echo "running sar ..."
pdsh -w node1,node2,node4,node5,node6,node7,node8,node9 'sar -b -u -r -n DEV 30 30' > /home/ceph-user/sar-logs/$new_fileName & #sar -b -u -r -n DEV 30 30
