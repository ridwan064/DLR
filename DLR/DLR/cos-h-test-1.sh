...
pdsh -w cosbench 'cd /home/ceph-user/cos; sh cli.sh submit conf/workload1.xml' &
...
# make affinity changes
/home/ceph-user/scripts/run_get_sar_data.sh &
...
ceph osd primary-affinity 1 1
ceph osd primary-affinity 2 1
ceph osd primary-affinity 3 1
ceph osd primary-affinity 4 1
ceph osd primary-affinity 5 1
ceph osd primary-affinity 6 1
ceph osd primary-affinity 7 1
sleep 120
i=`expr $i + 1`
done
